...
function HiringTest() {
  ...
  useEffect(() => {
    let computedMinutes = Math.floor(time / 60);
    let computedSeconds = time - computedMinutes * 60;
  ...
  return (
    <div className='App'>
      <header className='App-header'>
        ...
        <div>
          {!vanish && <h1 className='title-vanish'>1. Make this vanish</h1>}
          <button onClick={() => setVanish(!vanish)}>Click me!</button>
        </div>
        ...
        <div>
          ...
          <div className='button2'>
            ...
            <button className='button red' onClick={() => setStartTimer(false)}>
              Stop
            </button>
            <button className='button yellow' onClick={resetTime}>
              Reset
            </button>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor='age'>
                ...
                <input
                  value={form.age}
                  onInput={(e) => setForm({ ...form, age: e.target.value })}
                />
              </label>
            </div>
            <br />
